...
public class BannerUnsupportedResponseRepresentationExceptionHandler implements ExceptionHandler {

    /**
     * Will catch UnsupportedResponseRepresentationException unless explicitly catch by higher priority handlers
     * @param t
     * @return
     */
    @Override
    boolean supports(Throwable t) {
       return  (t instanceof net.hedtech.restfulapi.UnsupportedResponseRepresentationException)
    }
